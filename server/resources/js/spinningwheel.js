(function(exports) {
	...
	var SpinningWheel = {
		...
		create: function () {
			...
			document.addEventListener(MOVE_EV, this, false);			// Prevent page scrolling
		...
		destroy: function () {
			this.swWrapper&&this.swWrapper.removeEventListener('webkitTransitionEnd', this, false);

			this.swFrame&&this.swFrame.removeEventListener(START_EV, this, false);
			var cancle=document.querySelector('#sw-cancel'),done=document.querySelector('#sw-done');
			cancle&&cancle.removeEventListener(START_EV, this, false);
			done&&done.removeEventListener(START_EV, this, false);
		...
		scrollStart: function (e) {
			...
			var xPos = this.getTarget(e).clientX - this.swSlots.offsetLeft;	// Clicked position minus left offset (should be 11px)
			...
			this.startY =  this.getTarget(e).clientY;
		...
		scrollMove: function (e) {
			var topDelta =  this.getTarget(e).clientY - this.startY;
